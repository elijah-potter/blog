...
import classes from "./GenerativeArt.style.module.css";
...
export default function () {
  ...
  return (
    <>
      <div>
        <label className={classes.label}>Load File: </label>
        <input
          type="file"
        ...
        />
        <br />
        <label className={classes.label}>Select Algorithm: </label>
        <select
...
function downloadUint8Array(array: Uint8Array, filename: string) {
